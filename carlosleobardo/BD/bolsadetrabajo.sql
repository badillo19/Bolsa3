...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 27-11-2014 a las 02:22:28
...
CREATE TABLE IF NOT EXISTS `datos_usuario` (
  ...
  `No_movil` varchar(25) DEFAULT NULL,
  ...
  `registro_via` varchar(30) NOT NULL,
  `token_twitter` longtext NOT NULL,
...
INSERT INTO `datos_usuario` (`Id_usuario`, `Foto_perfil`, `Sexo`, `Nombre`, `Apellido_paterno`, `Apellido_materno`, `Correo_electronico`, `clave_acceso`, `No_movil`, `Tel_casa`, `Estado`, `Municipio`, `Grado`, `Especialidad`, `Curriculum`, `registro_via`, `token_twitter`) VALUES
(21, NULL, NULL, 'Angel Delgadillo', NULL, '', NULL, 'TemporalTwitter', NULL, NULL, '', NULL, NULL, NULL, NULL, 'Twitter', '228044915'),
(22, NULL, NULL, 'Jose Angel Delgadillo Basurto', NULL, '', 'joan.delgadillo@gmail.com', 'TemporalGoogle+', NULL, NULL, '', NULL, NULL, NULL, NULL, 'Google+', ''),
(20, 'foto_perfil_jodeba142664.jpg', 'm', 'JOSE ANGEL', 'DELGADILLO', 'BASURTO', 'zhizho@hotmail.com', 'TemporalFacebook', '8711347928', '8711347928', '1', '1', '', '1', 'curriculum_jodeba142664.pdf', 'Facebook', '');
...
CREATE TABLE IF NOT EXISTS `localidades` (
  ...
  `idmunicipio` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL,
  `localidad` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL,
  PRIMARY KEY (`idlocalidades`),
  UNIQUE KEY `idlocalidades_UNIQUE` (`idlocalidades`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;
...
--
-- Estructura de tabla para la tabla `t01tipocarrera`
--

CREATE TABLE IF NOT EXISTS `t01tipocarrera` (
  `t01idtipocarrera` bigint(20) NOT NULL AUTO_INCREMENT,
  `t01tipo` longtext COLLATE latin1_general_ci NOT NULL,
  PRIMARY KEY (`t01idtipocarrera`)
) ENGINE=MyISAM  DEFAULT CHARSET=latin1 COLLATE=latin1_general_ci AUTO_INCREMENT=7 ;

--
-- Volcado de datos para la tabla `t01tipocarrera`
--

INSERT INTO `t01tipocarrera` (`t01idtipocarrera`, `t01tipo`) VALUES
(1, 'Ingenierias'),
(2, 'Licenciaturas'),
(3, 'Maestrias'),
(4, 'Doctorado');
...
--
-- Estructura de tabla para la tabla `t02carrera`
--

CREATE TABLE IF NOT EXISTS `t02carrera` (
  `t02idcarrera` bigint(20) NOT NULL AUTO_INCREMENT,
  `t01idtipocarrera` int(11) NOT NULL,
  `t02carrera` longtext COLLATE latin1_general_ci NOT NULL,
  PRIMARY KEY (`t02idcarrera`)
) ENGINE=MyISAM  DEFAULT CHARSET=latin1 COLLATE=latin1_general_ci AUTO_INCREMENT=109 ;

--
-- Volcado de datos para la tabla `t02carrera`
--

INSERT INTO `t02carrera` (`t02idcarrera`, `t01idtipocarrera`, `t02carrera`) VALUES
(1, 1, 'Ing. Aeroespacial'),
(2, 1, 'Ing. Aeronáutica'),
(3, 1, 'Ing. Agroindustrial'),
(4, 1, 'Ing. Administrador de Sistemas'),
(5, 1, 'Ing. Ambiental'),
(6, 1, 'Ing. Biomédica'),
(7, 1, 'Ing. Biónica'),
(8, 1, 'Ing. Biotecnología'),
(9, 1, 'Ing. Bioquímica'),
(10, 1, 'Ing. Civil'),
(11, 1, 'Ing. Comercial'),
(12, 1, 'Ing. de Alimentos'),
(13, 1, 'Ing. en Arquitectura'),
(14, 1, 'Ing. de Software'),
(15, 1, 'Ing. de Minas y Metalurgia'),
(16, 1, 'Ing. en Comunicaciones y Electrónica'),
(17, 1, 'Ing. en Control y Automatización'),
(18, 1, 'Ing. en Electrónica y Automatización'),
(19, 1, 'Ing. en Energía'),
(20, 1, 'Ing. en Energías Renovables'),
(21, 1, 'Ingeniería informática'),
(22, 1, 'Ing. en Irrigación'),
(23, 1, 'Ing. Tecnología de Procesos'),
(24, 1, 'Ing. Telecomunicaciones'),
(25, 1, 'Ing. Telemática'),
(26, 1, 'Ing. Química'),
(27, 1, 'Ing. Química Industrial'),
(28, 1, 'Ing. Química Petrolera'),
(29, 1, 'Ing. en Materiales'),
(30, 1, 'Ing. en Manufactura'),
(31, 1, 'Ing. en Mecatrónica'),
(32, 1, 'Ing. en Negocios'),
(33, 1, 'Ing. en Robótica Industrial'),
(34, 1, 'Ing. en Semiconductores y Microelectrónica'),
(35, 1, 'Ing. en Sistemas Ambientales'),
(36, 1, 'Ing. en Sistemas Automotrices'),
(37, 1, 'Ingeniería en Sistemas computacionales'),
(38, 1, 'Ing. en Sistemas Automotrices'),
(39, 1, 'Ing. en Tecnología de Software'),
(40, 1, 'Ing. en Transporte'),
(41, 1, 'Ing. Farmacéutica'),
(42, 1, 'Ing. Física'),
(43, 1, 'Ing. Geomática'),
(44, 1, 'Ing. Geofísica'),
(45, 1, 'Ingenería industrial'),
(46, 1, 'Ing. Matemática'),
(47, 1, 'Ingeniería Electrónica'),
(48, 1, 'Ingeniería Electromecánica'),
(49, 2, 'Licenciatura Administración Agroindustrial'),
(50, 2, 'Licenciatura Administración de Empresas'),
(51, 2, 'Licenciatura Administración en Finanzas'),
(52, 2, 'Licenciatura Administración en Recursos Humanos'),
(53, 2, 'Licenciatura Administración en Turismo'),
(54, 2, 'Licenciatura Administración Pública'),
(55, 2, 'Licenciatura en Artes Visuales'),
(56, 2, 'Licenciatura en Bioquímica'),
(57, 2, 'Licenciatura en Ciencias Ambientales'),
(58, 2, 'Licenciatura en Ciencias de la Computación'),
(59, 2, 'Licenciatura en Diseño'),
(60, 2, 'Licenciatura en Gestión Ambiental'),
(61, 2, 'Licenciatura en Historia'),
(62, 2, 'Licenciatura en Lenguas Extranjeras'),
(63, 2, 'Licenciatura en Música'),
(64, 2, 'Licenciatura en Óptica'),
(65, 2, 'Licenciatura en Teología'),
(66, 2, 'Licenciatura en Turismo'),
(67, 3, 'Master Administración Pública'),
(68, 3, 'Master Ciencias Agrarias'),
(69, 3, 'Master Ciencias Sociales y Humanidades'),
(70, 3, 'Master Deportes y Educación Física'),
(71, 3, 'Master Educación'),
(72, 3, 'Master Hotelería y Turismo'),
(73, 3, 'Master Informática e Información'),
(74, 3, 'Master Periodismo y Ciencias de la Información'),
(75, 3, 'Master Publicidad y Marketing'),
(76, 3, 'Master Salud y Medicina'),
(77, 3, 'Master Arte y Bellas Artes'),
(78, 3, 'Master Ciencias Biológicas'),
(79, 3, 'Master Contabilidad Empresarial'),
(80, 3, 'Master Derecho / Leyes'),
(81, 3, 'Master Física y Química'),
(82, 3, 'Master Idiomas'),
(83, 3, 'Master Ingeniería y Tecnología'),
(84, 3, 'Master Programas Empresariales'),
(85, 3, 'Master Recursos Humanos - RRHH'),
(86, 3, 'Master Calidad'),
(87, 3, 'Master Economía y Finanzas'),
(88, 3, 'Master Moda / Diseño'),
(89, 4, 'Doctorado de Investigación en Ciencias Sociales'),
(90, 4, 'Doctorado Directo en Ingeniería'),
(91, 4, 'Doctorado en Administración'),
(92, 4, 'Doctorado en Administración de Negocios'),
(93, 4, 'Doctorado en Administración Pública'),
(94, 4, 'Doctorado en Alimentos'),
(95, 4, 'Doctorado en Ambiente y Sociedad'),
(96, 4, 'Doctorado en Antropología'),
(97, 4, 'Doctorado en Arquitectura'),
(98, 4, 'Doctorado en Artes'),
(99, 4, 'Doctorado en Biociencias'),
(100, 4, 'Doctorado en Bioética'),
(101, 4, 'Doctorado en Ciencia Administrativas'),
(102, 4, 'Doctorado en Ciencia e Ingeniería de la Computación'),
(103, 4, 'Doctorado en Ciencia Política'),
(104, 4, 'Doctorado en Ciencia y Tecnología'),
(105, 4, 'Doctorado en Ciencias - Ingeniería Industrial'),
(106, 4, 'Doctorado en Ciencias Agrarias');
